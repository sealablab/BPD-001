# Context Management Strategy - BPD-001

**Version:** 1.0 (BPD-001-specific)
**Purpose:** Token optimization and tiered loading for AI agents working on BPD-001
...
BPD-001 uses a **three-tier context loading strategy** to optimize token usage while ensuring AI agents have necessary information at the right time.
...
**Load these first:**
1. **Root `llms.txt`** - BPD-001 project structure
...
```
AI Agent loads:
1. llms.txt → "BPD-001 has bpd-core, bpd-drivers, bpd-vhdl + upstream libs"
...
- "What components make up BPD-001?"
...
BPD-001 is organized into clear components:
